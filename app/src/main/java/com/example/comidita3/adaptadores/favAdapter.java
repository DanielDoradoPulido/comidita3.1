...
public class favAdapter extends RecyclerView.Adapter<favAdapter.ViewHolder> implements Filterable {
    ...
    public favAdapter(Context context, List<Receta> exampleList, NavController navController) {
    ...
    public favAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new favAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.fav_items, parent, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            animationView = itemView.findViewById(R.id.animationFavs);

            nombre = itemView.findViewById(R.id.textViewNombreFavs);

            dificultad = itemView.findViewById(R.id.textViewDificultadFavs);
