...
public class perfilUserAdapter extends RecyclerView.Adapter<perfilUserAdapter.ViewHolder> implements Filterable {
    ...
    public perfilUserAdapter(Context context, List<Receta> exampleList, NavController navController) {
    ...
    @NonNull
    @Override
    public perfilUserAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new perfilUserAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.perfil_user_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull perfilUserAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            animationView = itemView.findViewById(R.id.animationPerfilUser);

            nombre = itemView.findViewById(R.id.textViewNombrePerfilUser);

            dificultad = itemView.findViewById(R.id.textViewDificultadPerfilUser);
